...
ALTER TABLE `Leagues` MODIFY COLUMN `Name` varchar(100) CHARACTER SET utf8mb4 NOT NULL;

ALTER TABLE `Leagues` MODIFY COLUMN `Country` varchar(50) CHARACTER SET utf8mb4 NOT NULL;

ALTER TABLE `Clubs` MODIFY COLUMN `DateOfEstablishment` date NOT NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20200628152716_ChangeLibAttributes', '3.1.5');
